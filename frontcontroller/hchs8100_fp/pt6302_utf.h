/**************************************************
 *
 * Conversion table UTF-8 -> ASCII for PT6302-007
 *
 * Note: the '-007' denotes the character generator
 *       inside the PT6302. Author's receivers have
 *       this version mounted on the PCB.
 *
 * Accented letter that are not available are shown
 * as the same letter without an accent.
 *
 */
unsigned char PT6302_UTF_C2[64] =
{
	...
	0xb5,	// 0xa1, inverted exclamation mark
	0xcb,	// 0xa2, cent sign
	0xaa,	// 0xa3, pound sign
	0x00,	// 0xa4, currency sign
	0x00,	// 0xa5, yen sign
	0x00,	// 0xa6, broken bar
	0x00,	// 0xa7, paragraph sign
	0x00,	// 0xa8, diaeresis
	0x00,	// 0xa9, copyright sign
	0x00,	// 0xaa, feminine ordinal indicator -
	0x00,	// 0xab, left pointing double angle quotation mark
	0x00,	// 0xac, not sign
	0x2d,	// 0xad, soft hyphen
	0x00,	// 0xae, registered sign
	0x00,	// 0xaf, macron

	0x00,	// 0xb0, degree sign
	0xb4,	// 0xb1, plus-minus sign
	0x00,	// 0xb2, superscript two
	0x00,	// 0xb3, superscript three
	0x00,	// 0xb4, acute accent
	0xb8,	// 0xb5, micro sign
	0x00,	// 0xb6, pilcrow sign
	0x00,	// 0xb7, middle dot
	0x00,	// 0xb8, cedilla
	...
	0xb9	// 0xbf, inverted question mark
};

unsigned char PT6302_UTF_C3[64] =
{
	// table: 0xc3 0xXX -> accented ASCII
	...
	0xa3,	// 0x85, capital A with accent ring above
	0xa7,	// 0x86, capital letter AE
	0x8b,	// 0x87, capital C with cedille
	...
	0xa2,	// 0x95, capital O with accent tilde
	0xa2,	// 0x96, capital O with accent diaeresis //Ö
	0x78,	// 0x97, multiplication sign
	0xb1,	// 0x98, capital O with stroke
	0x89,	// 0x99, capital U with accent grave
	0x88,	// 0x9a, capital U with accent acute
	0x98,	// 0x9b, capital U with accent circonflexe
	0x99,	// 0x9c, capital U with accent diaeresis //Ü
	0x55,	// 0x9d, capital Y with accent acute
	0x00,	// 0x9e, capital thorn
	0x8d,	// 0x9f, ringel-S  //ß

	0x81,	// 0xa0, small a with accent grave
	0x80,	// 0xa1, small a with accent acute
	0x61,	// 0xa2, small a with accent circonflexe
	0x91,	// 0xa3, small a with accent tilde
	0x91,	// 0xa4, small a with accent diaeresis //ä
	0x92,	// 0xa5, small a with accent ring above
	0xb7,	// 0xa6, small letter AE
	0x9b,	// 0xa7, small c with cedille
	0x83,	// 0xa8, small e with accent grave
	0x82,	// 0xa9, small e with accent acute
	0x92,	// 0xaa, small e with accent circonflexe
	0x93,	// 0xab, small e with accent diaeresis
	0x85,	// 0xac, small i with accent grave
	0x84,	// 0xad, small i with accent acute
	0x94,	// 0xae, small i with accent circonflexe
	0x95,	// 0xaf, small i with accent diaeresis

	0x00,	// 0xb0, small letter ETH
	0x9a,	// 0xb1, small n with accent tilde
	0x87,	// 0xb2, small o with accent grave
	0x86,	// 0xb3, small o with accent acute
	0x97,	// 0xb4, small o with accent circonflexe
	0x97,	// 0xb5, small o with accent tilde
	0x97,	// 0xb6, small o with accent diaeresis //ö
	0x2f,	// 0xb7, division sign
	0xbc,	// 0xb8, small o with stroke
	0x89,	// 0xb9, small u with accent grave
	0x88,	// 0xba, small u with accent acute
	0x98,	// 0xbb, small u with accent circonflexe
	0x97,	// 0xbc, small u with accent diaeresis //ü
...
unsigned char PT6302_UTF_C4[64] =
{
	...
	0xa5,	// 0x95, small e with accent breve
	...
	0x8e,	// 0xb0, capital I with dot above
	0x69,	// 0xb1, small i without dot
	0x8f,	// 0xb2, capital IJ
	0x79,	// 0xb3, small ij
...
unsigned char PT6302_UTF_C5[64] =
{
	...
	0x8a,	// 0x85, capital N with cedille
	0xa6,	// 0x86, small n with cedille
	0x4e,	// 0x87, capital N with accent caron
	0xa6,	// 0x88, small n with accent caron
	...
	0xa9,	// 0x92, capital OE
	0xa9,	// 0x93, small oe
	0xa9,	// 0x94, capital R with accent acute
