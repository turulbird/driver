...
int softi2c_init(void)
{
	...
	//printk("%s >\n", __func__);
	{
		...
		InitParam.SCLPioIndex   = GPIO_SIMULATE_I2C_SCL_PORT * PIO_BITS + GPIO_SIMULATE_I2C_SCL_BIT;
		InitParam.SDAPioIndex   = GPIO_SIMULATE_I2C_SDA_PORT * PIO_BITS + GPIO_SIMULATE_I2C_SDA_BIT;
