...
unsigned char PT6958_UTF_C4[64] =
{
	...
	0x77,	// 0x84, capital A with accent ogonek (polish accented A)
	0x51,	// 0x85, small a with accent ogonek (polish accented a)
	0x39,	// 0x86, capital C with accent acute (polish accented C)
	0x58,	// 0x87, small c with accent acute (polish accented c)
