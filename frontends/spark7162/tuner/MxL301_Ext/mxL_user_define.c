...
/*====================================================*
 ...
 Return Value u32(MxL_OK:Success, Others:Fail)
 *====================================================*/
u32 MXL301_register_read_reg_struct(u32 tuner_idx, MXL301_REG_STRUCT in_reg, u8 *pRegData)
{
	u8 nFilter = 0;
	u8 nReadData = 0;
	u8 i;
...
/*====================================================*
 ...
 Return Value u32(MxL_OK:Success, Others:Fail)
 *====================================================*/
u32 MXL301_register_write_reg_struct(u32 tuner_idx, MXL301_REG_STRUCT in_reg, u8 RegData)
{
	u8 nFilter = 0;
	u8 nWriteData = 0;
	u8 nReadData = 0;
