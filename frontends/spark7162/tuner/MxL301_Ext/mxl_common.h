...
typedef struct
{
	...
	u8 SHF_type;  /*SHF_type 0 : All, 1 : Non-split, 2 : Split */
} SHFType, *PSHFType;

/* extern definition for analg spur shift mode : V9.2.7.0 */
extern u8 Shfnum_NTSC;
extern u8 Shfnum_BG;
extern u8 Shfnum_DK;
extern u8 Shfnum_I;
extern u8 Shfnum_SECAM;
extern u8 Shfnum_CABLE;
extern u8 Shfnum_DVBT;
extern u8 Shfnum_ATSC;
