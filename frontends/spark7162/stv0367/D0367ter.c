...
#if 0
static int dvb_d0367_fe_ofdm_i2c_write(struct dvb_frontend *fe, U16 uAddr, unsigned char *pcData, int nData)
{
	int ret;
...
static int dvb_d0367_fe_ofdm_i2c_read(struct dvb_frontend *fe, U16 uAddr, unsigned char *pcData, int nData)
{
	int ret;
	struct dvb_d0367_fe_ofdm_state *state = fe->demodulator_priv;
	struct i2c_adapter *i2c = state->i2c;
...
static int dvb_d0367_fe_ofdm_read_status(struct dvb_frontend *fe, fe_status_t *status)
{
	struct dvb_d0367_fe_ofdm_state *state = fe->demodulator_priv;
	//int iTunerLock = 0;
	BOOL bIsLocked;
...
static int dvb_d0367_fe_ofdm_read_signal_strength(struct dvb_frontend *fe, u16 *strength)
{
	struct dvb_d0367_fe_ofdm_state *state = fe->demodulator_priv;
	TUNER_IOREG_DeviceMap_t *DeviceMap;
	IOARCH_Handle_t IOHandle;
...
static int dvb_d0367_fe_ofdm_read_ucblocks(struct dvb_frontend *fe, u32 *ucblocks)
{
	*ucblocks = 0;
	return 0;
}

static int dvb_d0367_fe_ofdm_get_frontend(struct dvb_frontend *fe, struct dvb_frontend_parameters *p)
{
	return 0;
}

static int dvb_d0367_fe_ofdm_set_frontend(struct dvb_frontend *fe, struct dvb_frontend_parameters *p)
{
	struct dvb_d0367_fe_ofdm_state *state = fe->demodulator_priv;
	TUNER_IOREG_DeviceMap_t *DeviceMap;
	IOARCH_Handle_t IOHandle;
...
static int dvb_d0367_fe_ofdm_get_info(struct dvb_frontend *fe, struct dvbfe_info *fe_info)
{
	//struct dvb_d0367_fe_ofdm_state* state = fe->demodulator_priv;
...
U32 D0367ter_GeChannelBW(TUNER_IOREG_DeviceMap_t *DeviceMap, IOARCH_Handle_t IOHandle)
{
	U32 ChannelBW = 8;
	struct dvb_d0367_fe_ofdm_state *state = NULL;
	struct dvb_frontend_parameters *p = NULL;
...
YW_ErrorType_T D0367ter_ScanFreq(TUNER_IOREG_DeviceMap_t *DeviceMap, IOARCH_Handle_t IOHandle)
{
