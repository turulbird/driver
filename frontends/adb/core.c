...
//	{ 0xF30c, 0x00000060, 0x0000F2F5 },  // this is not from bxzb
...
//		dprintk(20, "Attaching STB6100\n");
	...
	stb0899_config.lnb_enable = cfg->lnb_enable;  // TODO: can be removed?
	stb0899_config.lnb_vsel   = cfg->lnb_vsel;  // TODO: can be removed?
	return frontend;
