...
//We do not use the remote control of the DVB-T stick
//#define RC_ENABLE 1
...
extern int dvb_usb_device_init1(struct usb_interface *, struct dvb_usb_device_properties *, struct module *, struct dvb_usb_device **, short *adapter_nums);
extern void dvb_usb_device_exit1(struct usb_interface *);
