...
static struct it913xset it9135_38[] = {
	...
	{PRO_DMOD, 0x0081, {0x0a, 0x12, 0x02, 0x0a, 0x03, 0xc8, 0xb8, 0xd0, 0xc3, 0x01}, 0x0a},
	{PRO_DMOD, 0x008e, {0x01}, 0x01},
	...
	{PRO_DMOD, 0x00fc, {0x02, 0x02, 0x02, 0x09, 0x50, 0x7b, 0x77, 0x00, 0x02, 0xc8, 0x05, 0x7b}, 0x0c},
	...
	{PRO_DMOD, 0xf5f8, {0x01}, 0x01},
	{PRO_DMOD, 0xf5fd, {0x01}, 0x01},
	{PRO_DMOD, 0xf600, {0x05, 0x08, 0x0b, 0x0e, 0x11, 0x14, 0x17, 0x1f}, 0x08},
...
static struct it913xset it9135_51[] = {
	...
	{PRO_DMOD, 0x0075, {0x8c, 0x8c, 0x8c, 0xc8, 0x01}, 0x05},
	{PRO_DMOD, 0x007e, {0x04, 0x00}, 0x02},
	{PRO_DMOD, 0x0081, {0x0a, 0x12, 0x02, 0x0a, 0x03, 0xc0, 0x96, 0xcf, 0xc3, 0x01}, 0x0a},
	{PRO_DMOD, 0x008e, {0x01}, 0x01},
	{PRO_DMOD, 0x0092, {0x06, 0x00, 0x00, 0x00, 0x00}, 0x05},
	{PRO_DMOD, 0x0099, {0x01}, 0x01},
	{PRO_DMOD, 0x009b, {0x3c, 0x28}, 0x02},
	...
	{PRO_DMOD, 0x00f3, {0x05, 0x8c, 0x8c}, 0x03},
	{PRO_DMOD, 0x00f8, {0x03, 0x06, 0x06}, 0x03},
	{PRO_DMOD, 0x00fc, {0x03, 0x02, 0x02, 0x09, 0x50, 0x7a, 0x77, 0x01, 0x02, 0xb0, 0x02, 0x7a}, 0x0c},
	{PRO_DMOD, 0x0109, {0x02}, 0x01},
	{PRO_DMOD, 0x0115, {0x0a, 0x03, 0x02, 0x80}, 0x04},
...
static struct it913xset it9135_52[] = {
	...
	{PRO_DMOD, 0x007e, {0x04, 0x00}, 0x02},
	{PRO_DMOD, 0x0081, {0x0a, 0x12, 0x03, 0x0a, 0x03, 0xb3, 0x97, 0xc0, 0x9e, 0x01}, 0x0a},
	{PRO_DMOD, 0x008e, {0x01}, 0x01},
	{PRO_DMOD, 0x0092, {0x06, 0x00, 0x00, 0x00, 0x00}, 0x05},
	{PRO_DMOD, 0x0099, {0x01}, 0x01},
	{PRO_DMOD, 0x009b, {0x3c, 0x28}, 0x02},
	...
	{PRO_DMOD, 0x00f8, {0x03, 0x06, 0x06}, 0x03},
	{PRO_DMOD, 0x00fc, {0x03, 0x02, 0x02, 0x09, 0x50, 0x74, 0x77, 0x02, 0x02, 0xae, 0x02, 0x6e}, 0x0c},
	{PRO_DMOD, 0x0109, {0x02}, 0x01},
	{PRO_DMOD, 0x0115, {0x0a, 0x03, 0x02, 0x80}, 0x04},
...
static struct it913xset it9135_60[] = {
	...
	{PRO_DMOD, 0x00f8, {0x03, 0x06, 0x06}, 0x03},
	{PRO_DMOD, 0x00fc, {0x03, 0x03, 0x02, 0x0a, 0x50, 0x7b, 0x8c, 0x00, 0x02, 0xbe, 0x00}, 0x0b},
	{PRO_DMOD, 0x0109, {0x02}, 0x01},
	...
	{PRO_DMOD, 0x0141, {0x59, 0xf9, 0x19, 0x19, 0x8c, 0x8c, 0x8c, 0x6e, 0x8c, 0x50, 0x8c, 0x8c, 0xac, 0xc6, 0x33}, 0x0f},
...
static struct it913xset it9135_61[] = {
	...
	{PRO_DMOD, 0x00f3, {0x05, 0xa0, 0x8c}, 0x03},
	{PRO_DMOD, 0x00f8, {0x03, 0x06, 0x06}, 0x03},
	{PRO_DMOD, 0x00fc, {0x03, 0x03, 0x02, 0x08, 0x50, 0x7b, 0x8c, 0x01, 0x02, 0xc8, 0x00}, 0x0b},
	{PRO_DMOD, 0x0109, {0x02}, 0x01},
	{PRO_DMOD, 0x0115, {0x0a, 0x03}, 0x02},
	...
	{PRO_DMOD, 0x013f, {0x5b}, 0x01},
	{PRO_DMOD, 0x0141, {0x59, 0xf9, 0x59, 0x59, 0x8c, 0x8c, 0x8c, 0x7b, 0x8c, 0x50, 0x8c, 0x8c, 0xa8, 0xc6, 0x33}, 0x0f},
	{PRO_DMOD, 0x0151, {0x28}, 0x01},
...
static struct it913xset it9135_62[] = {
	...
	{PRO_DMOD, 0x007e, {0x04}, 0x01},
	{PRO_DMOD, 0x0081, {0x0a, 0x12}, 0x02},
	{PRO_DMOD, 0x0084, {0x0a, 0x33, 0xb8, 0x9c, 0xb2, 0xa6, 0x01}, 0x07},
	{PRO_DMOD, 0x008e, {0x01}, 0x01},
	{PRO_DMOD, 0x0092, {0x06, 0x00, 0x00, 0x00, 0x00}, 0x05},
	{PRO_DMOD, 0x0099, {0x01}, 0x01},
	{PRO_DMOD, 0x009b, {0x3c, 0x28}, 0x02},
	...
	{PRO_DMOD, 0x00f3, {0x05, 0x8c, 0x8c}, 0x03},
	{PRO_DMOD, 0x00f8, {0x03, 0x06, 0x06}, 0x03},
	{PRO_DMOD, 0x00fc, {0x02, 0x03, 0x02, 0x09, 0x50, 0x6e, 0x8c, 0x02, 0x02, 0xc2, 0x00}, 0x0b},
	{PRO_DMOD, 0x0109, {0x02}, 0x01},
	{PRO_DMOD, 0x0115, {0x0a, 0x03}, 0x02},
	...
	{PRO_DMOD, 0x013b, {0x05}, 0x01},
	{PRO_DMOD, 0x013f, {0x5b}, 0x01},
	{PRO_DMOD, 0x0141, {0x59, 0xf9, 0x59, 0x19, 0x8c, 0x8c, 0x8c, 0x7b, 0x8c, 0x50, 0x70, 0x8c, 0x96, 0xd0, 0x33}, 0x0f},
	{PRO_DMOD, 0x0151, {0x28}, 0x01},
...
static struct it913xset it9137_tuner_off[] = {
	...
	{PRO_DMOD, 0xec06, {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0x0c},
	{PRO_DMOD, 0xec12, {0x00, 0x00, 0x00, 0x00}, 0x04},
	{PRO_DMOD, 0xec17, {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0x09},
	{PRO_DMOD, 0xec22, {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0x0a},
