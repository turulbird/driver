...
static stm_display_denc_filter_setup_t default_luma_filter_config = {
  STM_FLT_DIV_1024,
  {0x03, 0x01, (unsigned int)0xfffffff7, 0xfffffffe, 0x1E, 0x05, 0xffffffa4, 0xfffffff9, 0x144, 0x206}
};
...
void CSTb7100DENC::ProgramOutputFormats(void)
{
  ...
  /*
   * Write the chroma multiplier.
   */
  UCHAR val = ReadDENCReg(DENC_CMTTX) & ~DENC_CMTTX_C_MULT_MASK;
